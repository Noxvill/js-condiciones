// Mostrar / ocultar borde imagen

document.querySelector("img").addEventListener("click", muestraborde)
...
// Parte 2, eligiendo la cantidad necesaria
...
if (suma <= 10){
  ...
  element.innerHTML = 'Llevas demasiados stickers:' + suma
}}

// Función para limpiar los campos de texto y el valor resultado
